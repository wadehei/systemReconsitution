    ...
    $.fn.extend({
        tableExport: function (options) {
            var defaults = {
                ...
                type: 'csv', // 'csv', 'txt', 'sql', 'company', 'xml', 'excel', 'doc', 'png' or 'pdf'
            ...
            if (defaults.type == 'csv' || defaults.type == 'txt') {
                ...
                try {
                    var blob = new Blob([sdata], { type: "application/company;charset=utf-8" });
                    saveAs(blob, defaults.fileName + '.json');
                }
                catch (e) {
                    downloadFile(defaults.fileName + '.json',
                                 'data:application/company;charset=utf-8;base64,',
                                 sdata);
                }
            ...
            function downloadFile(filename, header, data) {
                ...
                if (ua.indexOf("MSIE ") > 0 || !!ua.match(/Trident.*rv\:11\./)) {
                    ...
                    // ! Not working for company and pdf format !

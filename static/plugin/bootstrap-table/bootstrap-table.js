...
(function ($) {
    ...
    BootstrapTable.prototype.updateSelected = function () {
        ...
        if (checkAll) {
            this.$selectAll.add(this.$selectAll_).prop('checked', checkAll).closest('tr').addClass('selected');

        } else {
            this.$selectAll.add(this.$selectAll_).prop('checked', checkAll).closest('tr').removeClass('selected');

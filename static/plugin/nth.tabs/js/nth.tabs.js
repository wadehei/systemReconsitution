...
(function ($) {
    $.fn.nthTabs = function (options) {
        ...
        var template = '<div class="page-tabs"><a href="#" class="roll-nav roll-nav-left"><span class="fa fa-backward"></span></a><div class="content-tabs"><div class="content-tabs-container"><ul class="nav nav-tabs"></ul></div></div><a href="#" class="roll-nav roll-nav-right"><span class="fa fa-forward"></span></a><div class="dropdown roll-nav right-nav-list"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-chevron-down"></span></a><ul class="dropdown-menu"><li><a href="#" class="tab-close-current">关闭当前选项卡</a></li><li role="separator" class="divider"></li><li><a href="#" class="tab-close-other">关闭其他选项卡</a></li><li><a href="#" class="tab-close-all">关闭全部选项卡</a></li><li><a href="#" class="tab-location">定位当前选项卡</a></li><li role="separator" class="divider"></li><li class="scrollbar-outer tab-list-scrollbar"><div class="tab-list-container"><ul class="tab-list"></ul></div></li></ul></div></div><div class="tab-content" style="padding:0px"></div>';
        //各种api
        var methods = {
            //初始化
            init: function () {
            ...
            getActiveId: function () {
                var href = nthTabs.find('li[class="active"]').find("a").attr("href");
                if (href)
                    return href.replace('#', '');
                return href;
            },
            ...
            getActiveTitle: function () {
                return nthTabs.find('li[class="active"]').find("a").find("span").text();
            },
            //获取所有选项卡
            getTabList: function () {
                var tablist = [];
            ...
            addTab: function (options) {
                ...
                methods.locationTab(options.id);
                return methods;
            },
            //定位选项卡
            locationTab: function (tabId) {
                ...
                //即当前活动选项卡相对选项卡可视区域宽度的(余宽) = a+b-Math.floor(a/c)*c
                    ...
                    if (remaining <= settings.rollWidth * 0.7) {
                        ...
                        margin_left_total = 40 - Math.floor(width / settings.rollWidth) * settings.rollWidth;//修改
            ...
            delOtherTab: function () {
                var tabId = methods.getActiveId();
                if (tabId) {
                    nthTabs.find(".nav-tabs li").not('[class="active"]').remove();
                    nthTabs.find(".tab-content div").not('#' + tabId).remove();
                }
            },
            //删除全部选项卡
            delAllTab: function () {
